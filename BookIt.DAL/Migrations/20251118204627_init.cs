        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OwnedTenantId = table.Column<int>(type: "int", nullable: true),
                    IsTenantOwner = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    OffDays = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FavoriteTenants", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FavoriteTenants_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_FavoriteTenants_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BreakMinutesAfterService = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TenantId = table.Column<int>(type: "int", nullable: false),
                    BookingWeeksAhead = table.Column<int>(type: "int", nullable: false),
                    AutoRejectHours = table.Column<int>(type: "int", nullable: true),
                    AllowCancellation = table.Column<bool>(type: "bit", nullable: false),
                    CancellationHoursBefore = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PauseStart = table.Column<TimeSpan>(type: "time", nullable: true),
                    PauseEnd = table.Column<TimeSpan>(type: "time", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FavoriteTenants_TenantId",
                table: "FavoriteTenants",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_FavoriteTenants_UserId_TenantId",
                table: "FavoriteTenants",
